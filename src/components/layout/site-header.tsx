...
export function SiteHeader() {
    ...
    return (
        <div className="border-b bg-background/80 sticky top-0 left-0 right-0 z-50 backdrop-blur">
            <header className={cn(
                "flex h-16 shrink-0 items-center justify-between px-4 @3xl:px-6 ",
                ...
                <div className="flex items-center gap-4">
                    <Sheet open={leftOpen} onOpenChange={setLeftOpen}>
                        ...
                        <SheetContent side="left" className="w-[300px] @3xl:w-100 p-0 border-r-border/r bg-background">
                            <LeftSidebar />
                        </SheetContent>
                    </Sheet>
                    <div>
                        ...
                        {/* <p className="text-xs text-muted-foreground hidden @3xl:block">Read, Study, and Learn The Quran</p> */}
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <Button className="hidden @3xl:flex rounded-full bg-primary/10 text-primary hover:bg-primary/20 gap-2 font-medium ml-2">
                        Support Us <Heart className="h-4 w-4 fill-current" />
                    </Button>

                    <Sheet open={rightOpen} onOpenChange={setRightOpen}>
                        <SheetTrigger asChild>
                            <Button variant="ghost" size="icon" className="@7xl:hidden ml-2 rounded-full border border-border/10">
                                <Settings2 className="h-5 w-5" />
                                <span className="sr-only">Toggle settings panel</span>
                            </Button>
                        </SheetTrigger>
                        <SheetContent side="right" className="w-[300px] @3xl:w-100 p-0 border-l-border/l bg-background">
